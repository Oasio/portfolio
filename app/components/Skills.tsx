...
const skillGroups = [
  {
    ...
    skills: [
      ...
      { name: "Intellj IDEA (Rider, webstorm, ...)", icon: "https://upload.wikimedia.org/wikipedia/commons/9/9c/IntelliJ_IDEA_Icon.svg" },
  ...
  },
  {
    ...
    skills: [
      ...
      {
        name: "Java",
        icon: "https://th.bing.com/th?id=OSAAS.D8CE0A36BF5600CBE0F94BA7702AFA72&w=72&h=72&c=17&rs=1&o=6&dpr=1.3&pid=TechQna",
      },
      {
        name: "Kotlin",
      ...
      {name: "Skript", icon: "https://www.spigotmc.org/data/resource_icons/114/114544.jpg?1705441800"},
    ],
  },
  {
    category: "Database",
      ...
      <div className="container mx-auto px-6">
        ...
        >
          <AnimatedGradient className="inline-block">
            <h2 className="text-3xl md:text-4xl font-bold text-white px-4 py-2">Compétences</h2>
          </AnimatedGradient>
          <p className="text-gray-400">Mes compétence, outil et technologie</p>
        </motion.div>
