...
const Contact = () => {
  ...
  const contactInfo = [
    { icon: Mail, text: "elouan2003.danilo@gmail.com", href: "elouan2003.danilo@gmail.com" },
    { icon: Linkedin, text: "LinkedIn", href: "" },
    { icon: Phone, text: "06 11 84 08 36"},
  ]

  return (
      <section id="contact" className="py-20 bg-[#0A0A0A] font-poppins">
        <div className="container mx-auto px-6">
          ...
          >
            <AnimatedGradient className="inline-block">
              <h2 className="text-3xl md:text-4xl font-bold text-white px-4 py-2">Contact</h2>
            </AnimatedGradient>
          </motion.div>
          <div className="max-w-2xl mx-auto">
            ...
            <Link href="/resume" className="w-full">
              ...
              >
                ...
                <span className="text-white text-lg">CV</span>
              </motion.div>
            </Link>
          </div>
        </div>
